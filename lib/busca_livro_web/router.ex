defmodule BuscaLivroWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {BuscaLivroWeb.Layouts, :root}
  ...
  scope "/api/json" do
    ...
    forward "/", BuscaLivroWeb.AshJsonApiRouter
  end
  ...
  scope "/", BuscaLivroWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {BuscaLivroWeb.LiveUserAuth, :live_no_user}
    end
  end
  ...
  scope "/", BuscaLivroWeb do
    ...
    live "/achados", AchadosLive.Index, :index
    ...
    confirm_route BuscaLivro.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [BuscaLivroWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(BuscaLivro.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [BuscaLivroWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.Default]
    )
  end
  ...
  # scope "/api", BuscaLivroWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:busca_livro, :dev_routes) do

...
config :busca_livro, BuscaLivroWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BuscaLivroWeb.ErrorHTML, json: BuscaLivroWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: BuscaLivro.PubSub,
  live_view: [signing_salt: "0S/qx56T"]
...
config :busca_livro, BuscaLivro.Mailer, adapter: Swoosh.Adapters.Local

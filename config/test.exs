...
config :busca_livro, token_signing_secret: "Ec6uMInDOHGsiyOh8bx5UWphETBQRZyG"
...
config :busca_livro, BuscaLivroWeb.Endpoint,
  ...
  secret_key_base: "bSbsOpmLLsLMm0/JO7nsr6BzEhpjJnEfZL6etXr/HM6FrMQE4CYdmBvAl84KZ1XT",
  server: false
